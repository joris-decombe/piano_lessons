...
export default function Home() {
  ...
  // Song Management
  const songs = [
    { id: 'gnossienne1', title: 'Gnossienne No. 1', artist: 'Claude Debussy', url: '/gnossienne1.mid' },
    { id: 'twinkle', title: 'Twinkle Twinkle Little Star', artist: 'Traditional (Clean Piano)', url: '/twinkle.mid' },
  ];
